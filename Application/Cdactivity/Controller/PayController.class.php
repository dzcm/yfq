...
class PayController extends Controller
{
    ...
    {
        $rr = require_once SDK_PATH . 'dbwxapi/sdk/Nonghangdb/ebusclient/PaymentRequest.php';
        ...
        $tRequest->order['CommodityType'] = '0202';
        ...
        $tRequest->request['ResultNotifyURL'] = 'http://yfq.duobakeji.com/Cdactivity/Pay/getstatus';
    ...
    function getstatus()
    {
        ...
        header("Location:http://yfq.sjzdezhong.com/Cdactivity?sub=1");
    }
}