 ...
 */(function(L) {
	...
	L.jqplot.config = {
		...
		defaultColors : [
		"#0ea5aa","#FF0000","#000F0F","#0000FF","#00F0F0","#f18e97","#7428f1","#e33cec","#f8cee1","#FFC125","#00FF00","#1ce9cb","#b1e91c","#175612","#8c62a3","#a3a062","#bbfcb6","#e9971c","#F0F000","#c498f1"
				],
	...
	L.fn
			.extend({
				jqplotEffect : function(ap, aq, ai, ao) {
					var an = j.apply(this, arguments), ak = an.mode, al = an.queue, am = L.jqplot.effects.effect[an.effect], ah = !am
